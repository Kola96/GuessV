...
class ComparisonServiceTest {
    ...
    private Vtuber v(String name, List<String> platforms, String group, Integer year,
                     ...
                     List<String> hair, List<String> langs, Integer followers) {
        Vtuber v = new Vtuber();
        ...
        v.setHairColor(hair); v.setLanguages(langs); v.setFollowerCount(followers);
        return v;
    }
    ...
    void allExactMatch() {
        Vtuber g = v("Gura", List.of("YouTube", "Twitter"), "Hololive EN", 2020, "06-20",
                "female", "active", List.of("蓝"), List.of("英语"), 4400000);
    ...
    void groupPartialSameCompany() {
        ...
        Vtuber target = v("B", List.of("bilibili"), "Hololive EN", 2020, "02-02",
                "female", "active", List.of("白"), List.of("英语"), 200000);
    ...
    void platformsPartialOverlap() {
        ...
        Vtuber target = v("B", List.of("YouTube", "Bilibili"), "G", 2020, "02-02",
                "female", "active", List.of("白"), List.of("汉语"), 200000);
        assertEquals("partial", comparisonService.compare(guess, target).platforms().match());
    }

    @Test
    void platformsNoneNoOverlap() {
        Vtuber guess = v("A", List.of("bilibili"), "G", 2020, "01-01",
                "female", "active", List.of("白"), List.of("汉语"), 100000);
        Vtuber target = v("B", List.of("YouTube", "Twitter"), "G", 2020, "02-02",
                "female", "active", List.of("白"), List.of("英语"), 200000);
        assertEquals("none", comparisonService.compare(guess, target).platforms().match());
    }

    @Test
    void languagesPartialOverlap() {
        Vtuber guess = v("A", List.of("YouTube"), "G", 2020, "01-01",
                "female", "active", List.of("白"), List.of("英语", "日语"), 100000);
        Vtuber target = v("B", List.of("YouTube"), "G", 2020, "02-02",
                "female", "active", List.of("白"), List.of("日语", "德语"), 200000);
        assertEquals("partial", comparisonService.compare(guess, target).languages().match());
    }

    @Test
    void languagesNoneNoOverlap() {
        Vtuber guess = v("A", List.of("YouTube"), "G", 2020, "01-01",
                "female", "active", List.of("白"), List.of("英语"), 100000);
        Vtuber target = v("B", List.of("YouTube"), "G", 2020, "02-02",
                "female", "active", List.of("白"), List.of("日语"), 200000);
        assertEquals("none", comparisonService.compare(guess, target).languages().match());
    }
    ...
    void followerCountHigherWhenTargetMore() {
        Vtuber guess = v("A", List.of("bilibili"), "G", 2020, "01-01",
                "female", "active", List.of("白"), List.of("日语"), 100000);
        Vtuber target = v("B", List.of("bilibili"), "G", 2020, "02-02",
                "female", "active", List.of("白"), List.of("日语"), 2000000);
    ...
    void followerCountPartialWhenClose() {
        Vtuber guess = v("A", List.of("bilibili"), "G", 2020, "01-01",
                "female", "active", List.of("白"), List.of("日语"), 1000000);
        Vtuber target = v("B", List.of("bilibili"), "G", 2020, "02-02",
                "female", "active", List.of("白"), List.of("日语"), 1050000);
    ...
    void hairColorPartialOverlap() {
        Vtuber guess = v("A", List.of("bilibili"), "G", 2020, "01-01",
                "female", "active", List.of("蓝"), List.of("日语"), 100000);
        Vtuber target = v("B", List.of("bilibili"), "G", 2020, "02-02",
                "female", "active", List.of("蓝", "白"), List.of("日语"), 200000);
        assertEquals("partial", comparisonService.compare(guess, target).hairColor().match());
    }

    @Test
    void nullFieldsBothNullCountsAsExact() {
        Vtuber guess = v("A", null, null, null, null, null, null, null, null, null);
        Vtuber target = v("B", null, null, null, null, null, null, null, null, null);
